...
public class BugreportController extends AsyncTask<String, Void, String> {
    ...
    public BugreportController(Activity activity, Context context, String report, int idUsuario) {
    ...
    protected void onPreExecute() {
        dialog.setMessage("Enviando o relatório...");
    ...
    protected void onPostExecute(String content) {
        ...
        if (error) {
            ...
            toast = Toast.makeText(context,
                    "Relatório enviado com sucesso!", Toast.LENGTH_LONG);
            toast.setGravity(Gravity.TOP, 25, 400);
            toast.show();
            activity.finish();
        }
